...
namespace BTL_ASPdotNet.Helpers
{
	...
	public class RandomStringGenerator
	{
		...
		bool m_UseUpperCaseCharacters, m_UseLowerCaseCharacters, m_UseNumericCharacters, m_UseSpecialCharacters;
		int m_MinUpperCaseCharacters, m_MinLowerCaseCharacters, m_MinNumericCharacters, m_MinSpecialCharacters;
		bool PatternDriven;
		char[] CurrentUpperCaseCharacters;
		char[] CurrentLowerCaseCharacters;
		char[] CurrentNumericCharacters;
		char[] CurrentSpecialCharacters;
		char[] CurrentGeneralCharacters; // All used characters
		RNGCryptoServiceProvider Random;
		List<string> ExistingStrings; // History
		#endregion
		...
		char GetRandomCharFromArray(char[] array, List<char> existentItems)
		{
			char Character = ' ';
			do
			{
